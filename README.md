...
De broncode voor de tracking algoritmes en aansturing is te vinden in de [Software](Software/README.md) map. We maken gebruik van Python, OpenCV, YOLO,... voor de beeldverwerking en data-analyse.


### Documentatie

De algemene documentatie voor het project is te vinden in de [Documentatie](Documentatie/README.md) map. Hierin vind je technische specificaties, flowcharts en uitleg over de werking van het tracking algoritme.
...
<img src="./Media/FinalePoster.png" height="auto">
